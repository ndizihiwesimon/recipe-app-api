...
class PublicUserApiTest(TestCase):
    ...
    def test_create_valid_user_success(self):
        """Test creating user with valid payload if is successful"""
        payload = {
            "email": "test@test.com",
            "password": "testPass",
            "name": "Test name"
    ...
    def test_create_token_no_user(self):
        ...
        payload = {"email": "test@nomisodev.com", "password": "testPass"}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_missing_field(self):
        ...
        res = self.client.post(
            TOKEN_URL,
            {"email": "test@nomisodev.com", "password": ""}
        )
        self.assertNotIn('token', res.data)
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        ...
        payload = {'name': 'New Nomiso', 'email': 'new@nomisodev.com', 'password': 'NewPassword'}
